 ...
 * @since 3.0
 */
class Formidable_Digitalocean_Spaces_Field_File extends FrmFieldType {
	/**
	 * @var string
	 * @since 3.0
	 */
	protected $type = 'digitalocean_file';

	private $entry_id;

	protected function include_form_builder_file() {
		return FrmProAppHelper::plugin_path() . '/classes/views/frmpro-fields/back-end/field-file.php';
	}
